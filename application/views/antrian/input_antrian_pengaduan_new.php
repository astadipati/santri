                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            ...
                            <h1 class="judulh1_sub">ANTRIAN PENGADUAN</h1>
        ...
        <tbody>
			...
			if (!empty($arr_nomorantrian)){
				...
				while($row = mysql_fetch_assoc($arr_nomorantrian)) {
					...
					$onclick = "window.open('".base_url('antrian/panggil_antrian_pengaduan/'.base64_encode($this->encrypt->encode($row['id'])).'/'.$panggil_no_perk)."')";
					$onclick2 = "window.open('".base_url('antrian/panggil_antrian_pengaduan_selesai/'.base64_encode($this->encrypt->encode($row['id'])).'/'.$panggil_no_perk)."')";
