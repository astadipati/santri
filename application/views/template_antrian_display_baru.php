                    ...
                    <div class="col-md-4 hilang-padding-left">
                        ...
                        <div class="menu-item blue ganti-padding-top-bottom">
                            <a href="#feature-modal">
                                 <p class="nomor_antrian" id="nomor_antrian_terakhir_sidang_1">----</p>
                                <p class="detail_tv" id="nosidang_1">-----------</p>
                                <p class="detail_tv" id="psidang_1">-----------</p>
                                <p class="detail_tv" id="tsidang_1">------------</p>
                        ...
                        <div class="menu-item green ganti-padding-top-bottom">
                            <a href="#portfolio-modal">
                                <p class="nomor_antrian" id="nomor_antrian_terakhir_sidang_2">----</p>
                                <p class="detail_tv" id="nosidang_2">-----------</p>
                                <p class="detail_tv" id="psidang_2">-----------</p>
                                <p class="detail_tv" id="tsidang_2">------------</p>
                        ...
                        <div class="menu-item light-red ganti-padding-top-bottom">
                            <a href="#about-modal" data-toggle="modal">
                                <p class="nomor_antrian" id="urutanmediasi">-----</p>
                                <p class="detail_tv" id="nomediasi">---------</p>
                                <p class="detail_tv" id="pmediasi">-------</p>
                                <p class="detail_tv" id="tmediasi">--------</p>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 hilang-padding-left hilang-padding-right">
                                <div class="menu-item light-orange ganti-padding-top-bottom">
                                    <a href="#team-modal" data-toggle="modal">
                                        <p class="nomor_antrian" id="urutanpendaftaran">----</p>
                                        <p class="detail_tv">-------------</p>
                            ...
                            <div class="col-md-6 hilang-padding-left hilang-padding-right">
                                <div class="menu-item light-orange ganti-padding-top-bottom">
                                    <a href="#team-modal" data-toggle="modal">
                                        <p class="nomor_antrian" id="urutanmeja1">----</p>
                                        <p class="detail_tv">-------------</p>
                                        <p class="detail_tv">P : ---------</p>
                                        <p class="detail_tv">T : ---------</p>
                    ...
                    <div class="col-md-4 hilang-padding-right">
                        ...
                        <div class="menu-item light-red ganti-padding-top-bottom">
                            <a href="#contact-modal" data-toggle="modal">
                                <p class="nomor_antrian" id="urutankasir">----</p>
                                <p class="detail_tv" id="nokasir">----------</p>
                                <p class="detail_tv" id="pkasir">----------</p>
                                <p class="detail_tv" id="tkasir">----------</p>
                        ...
                        <div class="menu-item color ganti-padding-top-bottom">
                            <a href="#testimonial-modal" data-toggle="modal">
                                <p class="nomor_antrian" id="urutanac">----</p>
                                <p class="detail_tv" id="noac">----------</p>
                                <p class="detail_tv" id="pac">----------</p>
                                <p class="detail_tv" id="tac">----------</p>
                        ...
                        <div class="menu-item blue ganti-padding-top-bottom">
                            <a href="#news-modal" data-toggle="modal">
                                <p class="nomor_antrian" id="urutanpengaduan">-----</p>
                                <p class="detail_tv">----------</p>
                                <p class="detail_tv">-------------------------</p>
                                <p class="detail_tv">----------</p>
